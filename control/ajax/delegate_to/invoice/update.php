<?php
	...
	if($_POST['step'] == 'update') {
		...
		if( $_POST['invoice_status'] == "") {
			$cache_html .= $oConfigs->get('cadastro_invoice','dig_status_invoice') . "<br>";
			$error = true;
		}
		...
		if(
				!$_POST['docs_packinglist_status_changes'] ||
				!$_POST['docs_formei_status_changes'] ||
				!$_POST['docs_fumigacao_status_changes'] ||
				!$_POST['docs_bl_status_changes'] ||
				!$_POST['docs_invoice_status_changes'] ||
				!$_POST['docs_ISF_status_changes']
		) {
			$cache_html .= $oConfigs->get('cadastro_invoice','erro_integridade_status_change') . "<br>";
			$error = true;
		}
	...
	if($_FILES['docs_packinglist']['name']) 
		...
		$arrDocs['docs_packinglist'] = $oInvoice->lockDoc(
				$_POST['docs_packinglist_name'],
				$_POST['docs_packinglist_lock_status'],
				$_POST['docs_packinglist_status_changes']
		);
	}
	...
	if($_FILES['docs_formei']['name'])
		...
		$arrDocs['docs_formei'] = $oInvoice->lockDoc(
				$_POST['docs_formei_name'],
				$_POST['docs_formei_lock_status'],
				$_POST['docs_formei_status_changes']
		);
	}
	...
	if($_FILES['docs_fumigacao']['name'])
		...
		$arrDocs['docs_fumigacao'] = $oInvoice->lockDoc(
				$_POST['docs_fumigacao_name'],
				$_POST['docs_fumigacao_lock_status'],
				$_POST['docs_fumigacao_status_changes']
		);
	}
	...
	if($_FILES['docs_bl']['name'])
		...
		$arrDocs['docs_bl'] = $oInvoice->lockDoc(
				$_POST['docs_bl_name'],
				$_POST['docs_bl_lock_status'],
				$_POST['docs_bl_status_changes']
		);
	...
	if($_FILES['docs_invoice']['name'])
		...
		$arrDocs['docs_invoice'] = $oInvoice->lockDoc(
				$_POST['docs_invoice_name'],
				$_POST['docs_invoice_lock_status'],
				$_POST['docs_invoice_status_changes']
		);
	}
	...
	if($_FILES['docs_ISF']['name'])
		...
		$arrDocs['docs_ISF'] = $oInvoice->lockDoc(
				$_POST['docs_ISF_name'],
				$_POST['docs_ISF_lock_status'],
				$_POST['docs_ISF_status_changes']
		);
